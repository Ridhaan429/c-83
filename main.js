...
{
display_studant_array.push("<h4>NAME -" + name_of_the_student_array[k] + "</h4>");
console.log(display_studant_array);

}console.log(display_studant_array);
document.getElementById("display_name_with_commas").innerHTML = display_studant_array;

var remove_commas = display_studant_array.join(" ");
